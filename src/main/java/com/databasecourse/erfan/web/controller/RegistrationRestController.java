...
import com.databasecourse.erfan.web.dto.PasswordDto;
import com.databasecourse.erfan.web.dto.UserDto;
import com.databasecourse.erfan.web.error.InvalidOldPasswordException;
...
public class RegistrationRestController {
    ...
    public GenericResponse registerUserAccount(@Valid final UserDto accountDto, final HttpServletRequest request) {
        ...
        System.out.println("---------- user create -----------");
          ...
          String returnedText =   userService.registerNewUserAccount(accountDto);
//        userService.addUserLocation(registered, getClientIP(request));
//        eventPublisher.publishEvent(new OnRegistrationCompleteEvent(accountDto.getPassword(), registered, request.getLocale(), getAppUrl(request)));
