...
import com.databasecourse.erfan.validation.EmailValidator;
import com.databasecourse.erfan.validation.PasswordMatchesValidator;
...
@Configuration
@ComponentScan(basePackages = { "com.databasecourse.erfan.web" })
@EnableWebMvc
